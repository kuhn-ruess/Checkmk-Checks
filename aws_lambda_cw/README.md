...
Special agent that monitors AWS Lambda functions through CloudWatch. Built-in
Lambda monitoring in Checkmk is a **Checkmk Ultimate** feature; this plugin
covers the same core metrics on editions without that integration.
...
> Enterprise/CEE-based editions) and an IAM access key with

        ...
        elements={
            "alteon_throughput_tresholds": DictElement(
                parameter_form=SimpleLevels(
                    title=Title("Thresholds (warn/crit) for Alteon Throughput per SP core"),
...
rule_spec_alteon_throughput = CheckParameters(
    ...
    parameter_form=_parameter_valuespec_alteon_throughput,
    title=Title("Alteon Throughput"),
)

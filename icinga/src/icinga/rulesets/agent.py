    ...
    return Dictionary(
        ...
        elements={
            ...
            'group_services': DictElement(
                parameter_form=BooleanChoice(
                    title=Title("Group sub items"),
                    label=Title("Combine sub items of a service into one service (list in the details)"),
                    prefill=DefaultValue(True),
                ),
                required=False,
            ),
            'piggyback_prefix': DictElement(
                parameter_form=String(
                    title=Title("Piggyback host prefix"),
                    help_text=Help(
                        "Optional prefix prepended to every piggyback host "
                        "name generated by the agent."
                    ),
                ),
                required=False,
            ),
